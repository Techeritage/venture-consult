          ...
          <div className="relative h-[97vh] md:h-screen">
            ...
            <div className="absolute bg-black/60 top-0 bottom-0 left-0 right-0 content">
              ...
              <div className="relative w-full h-full flex items-center px-[3%] lg:px-[5%]">
                <div>
                  <h1 className="text-content max-w-[95%] md:max-w-[65%] opacity-0">
                    {slide.headline}
                  </h1>
                  <p className="mt-2 text-content max-w-[75%] md:max-w-[45%] opacity-0 text-opacity-90">
                    {slide.description}
                  </p>
                  <button className="opacity-0 mt-8 px-6 h-[56px] bg-lightBg font-semibold text-black rounded-full text-content">
                    {slide.cta}
                  </button>
                </div>
              </div>
